...
export default function Home() {
  ...
  const handleSearch = (event: FormEvent<HTMLFormElement>) => {
    ...
    setError('');
    if (!/^[A-Z]{3}\d{9}$/.test(normalizedCode)) {
    ...
    router.push(`/envios/info?tracking=${encodeURIComponent(normalizedCode)}`);
  };
    ...
    <div className="space-y-12">
      ...
      <section className="bg-white rounded-2xl shadow-sm p-8 md:p-16 text-center border border-gray-100">
        ...
        <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
          Plataforma logística integral. Rastreos en tiempo real, creación de guías y administración operativa centralizada.
        </p>

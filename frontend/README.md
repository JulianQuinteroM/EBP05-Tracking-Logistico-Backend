...
4. Abre `http://localhost:3000` en Edge o Chrome. Busca un envío por código sin ingresar. Para crear/listar/editar/cancelar, elige “Ingresar como operador” e introduce la misma contraseña.
...
- “Eliminar” se cambió por **Cancelar**: pide motivo, llama al backend y el envío permanece en el listado como `CANCELADO`. Editar/cancelar solo se permiten en `PENDIENTE_RECOGIDA`; HTTP 409 exige recargar la ficha.
